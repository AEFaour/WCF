...
namespace WcfServiceGestionGarage
{
    ...
    public interface IWSGarage
    {
        ...
        //API REST
        // Liste des voitures format Json
        ...
        // Liste des voitures au format XML
        ...
        //ajouter une voiture
        // Voiture est un objet : type complexe ne peut pas passer par Get(via l'URL), on utilise WebInvoke qui permet de faire
        // un Post
